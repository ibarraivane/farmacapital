  ...
  if v_id is not null and (select estado from public.recepciones where id = v_id) <> 'borrador' then
    ...
    for r in
      select * from (values
        ...
        ('', 'Gerber Etapa 2 Mango 100 g', 3, 10.68, null),
        ('', 'Gerber Etapa 2 Pera 100 g', 3, 10.68, null),
        ('', 'Gerber Etapa 2 Durazno 100 g', 3, 10.68, null),
        ('', 'Gerber Etapa 2 Comida Casera Pollo 100 g', 4, 10.68, null),
        ('', 'Gerber Etapa 2 Comida Casera Res 100 g', 4, 10.68, null),
        ('', 'Papilla Heinz Pouch Manzana 113 g', 3, 14.40, null),
        ('', 'GERBER POUCH JR FRUT MIXT 95 g', 3, 12.79, null),
