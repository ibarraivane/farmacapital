-- ============================================================================ 
-- Auditoría inventario 16-ago-2026 · UN SOLO ARCHIVO
-- 1) RPC margen por unidad  2) datos (jeringas, categorías, precios, EAN)
-- Pegar completo en Supabase → SQL Editor → Run.
-- No borra productos ni referencias de Similares.
-- ============================================================================ 
