-- ============================================================
-- FARMAX — F4a: RPCs sin escrituras a columnas legacy
-- ============================================================
--
-- Objetivo: preparar el DROP de F4b. Deja de escribir:
--   - pedido_items.lote, pedido_items.caducidad (de create_sale_transaction_v2)
--   - productos.lote, productos.fecha_caducidad (de create_producto_with_lote
--     y receive_merchandise_lote)
--
-- Es idempotente (CREATE OR REPLACE). No dropea nada todavia, solo
-- reemplaza las funciones para que desde ya solo escriban en la tabla
-- canonica `lotes`.
--
-- Orden:
--   1. Correr este SQL (RPCs actualizadas, columnas legacy siguen existiendo).
--   2. Desplegar frontend F4.1-F4.3 (lectores usan JOIN a lotes).
--   3. Correr sql/refactor_fase4b_drop_legacy.sql (DROP definitivo).
-- ============================================================

begin;

-- ============================================================
-- 1) create_sale_transaction_v2: NO escribir pedido_items.lote/caducidad
-- ============================================================
-- Solo persiste lote_id (FK). El numero_lote y la fecha_caducidad
-- quedan accesibles via JOIN a lotes cuando se necesiten.
-- ============================================================
...
-- ============================================================
-- 3) receive_merchandise_lote: NO escribir productos.lote/fecha_caducidad
-- ============================================================
-- Sigue actualizando metadata relevante del producto (costo/proveedor),
-- pero ya no toca lote ni fecha_caducidad (esos viven solo en lotes).
-- ============================================================
...
begin
  ...
  -- F4: solo metadata de producto (costo, proveedor). NO lote ni fecha_caducidad.
  update public.productos
  set
...
-- FIN F4a
-- ============================================================
-- Siguiente paso: desplegar frontend F4.1-F4.3 (lectores via JOIN lotes).
-- Despues: sql/refactor_fase4b_drop_legacy.sql (DROP definitivo).
-- ============================================================
