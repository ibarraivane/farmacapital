...
insert into _fc_rx_farmalive12790 (linea, ean, sku, nombre, qty, costo) values
  (1, '7501065065322', null, 'Advil 12 Horas ibuprofeno 600 mg C/6 | Haleon', 1, 222.46),
...
select
  ...
  3534.11,
  'borrador',
  'Pedido Farmalive 12790 · Club Iztapalapa 1 · 15-sep-2026 · EAN del ticket (Advil PR346/PR347 → EAN Haleon) · precio neto (2%/5%/8%) · promos Prudence @$0.01 · cola Recibir; stock al confirmar pistola'
where not exists (
...
set
  ...
  fecha = '2026-09-15',
  proveedor = 'Farmalive',
  notas = 'Pedido Farmalive 12790 · Club Iztapalapa 1 · 15-sep-2026 · EAN del ticket (Advil PR346/PR347 → EAN Haleon) · precio neto (2%/5%/8%) · promos Prudence @$0.01 · cola Recibir; stock al confirmar pistola',
  updated_at = now()
where folio = '12790'
