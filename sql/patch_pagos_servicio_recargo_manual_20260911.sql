...
-- Recibos / otros (CFE, Sky, metro, …): default 0; el piso puede poner monto a mano.
-- Sustituye sql/patch_pagos_servicio_recarga_sin_recargo_20260826.sql que
-- exigía recargo > 0 en recibos.
...
begin
  ...
  if v_cat = 'recarga' then
    ...
    raise exception 'Recargo inválido. Usa 0 o un monto positivo.';
  end if;
