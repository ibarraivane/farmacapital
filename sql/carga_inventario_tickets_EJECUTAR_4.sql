...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-76', NULL, 15.8, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-80', NULL, 21.7, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-81', NULL, 212.86, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-91', NULL, 108.88, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-92', NULL, 75.2, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-96', NULL, 10.19, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-105', NULL, 30.67, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-110', NULL, 20.5, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-111', NULL, 20.09, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-112', NULL, 20.09, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-113', NULL, 20.5, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-114', NULL, 20.5, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-116', NULL, 11.76, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-118', NULL, 39.6, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-126', NULL, 18.9, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-131', NULL, 28.0, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-140', NULL, 21.36, 'FarmaLive', null
    );
  end if;
end $$;
...
begin
  ...
  if v_pid is null then
    ...
    perform lote_id from receive_merchandise_lote(
      v_pid, 1, 'TK-FL-080826-141', NULL, 7.45, 'FarmaLive', null
    );
  end if;
end $$;
