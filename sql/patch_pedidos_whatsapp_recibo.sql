-- FARMAX — Preferencia de recibo por WhatsApp en pedidos online
-- Ejecutar en Supabase SQL Editor tras backup.
-- El checkout guarda si el cliente quiere recibo por WhatsApp;
-- el webhook de Mercado Pago y /api/notifications/order-receipt respetan esta bandera.
...
comment on column public.pedidos.whatsapp_recibo is
  'true = el cliente pidió recibo/confirmación por WhatsApp al checkout online.';
...
begin
  ...
  insert into public.pedidos (
    cliente_id, total, estado, tipo, tipo_entrega, direccion, metodo_pago, whatsapp_recibo
  ) values (
