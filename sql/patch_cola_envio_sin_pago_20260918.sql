...
-- Pedido #333 (domicilio, sin cobro) no salía en POS → Pedidos online:
-- el RPC exigía Mercado Pago approved. El historial (#335) no mandaba
-- payment_status y la UI decía «Pago por confirmar» aunque ya estaba pagado.
