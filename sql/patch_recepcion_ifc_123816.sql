-- Pedido IFC F8 Tienda 123816 (2026-09-12) — cola Recibir, borrador.
...
create temp table _fc_rx_ifc123816 (
...
select
  ...
  65.00,
  'borrador',
  'Farma Centre / IFC F8 Tienda · folio 123816 · MAYOREO+MENUDEO · 12-sep-2026 16:07 · sin EAN GS1 (códigos IFC) · cola Recibir; stock al confirmar pistola · ligar EAN de caja'
where not exists (
  select 1 from public.recepciones
  where folio = '123816' and coalesce(proveedor, '') ilike '%ifc%'
);
...
set
  ...
  notas = 'Farma Centre / IFC F8 Tienda · folio 123816 · MAYOREO+MENUDEO · 12-sep-2026 16:07 · sin EAN GS1 (códigos IFC) · cola Recibir; stock al confirmar pistola · ligar EAN de caja',
  updated_at = now()
where folio = '123816'
...
where r.folio = '123816' and coalesce(r.proveedor, '') ilike '%ifc%'
order by i.id;
