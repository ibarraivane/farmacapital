-- ============================================================
-- Mi Día: ventas de la sesión de caja (igual que el corte)
-- 14-sep-2026. Idempotente. Pegar en Supabase SQL Editor.
--
-- Suma pedidos etiquetados a ella O ocurridos mientras su caja
-- estuvo abierta hoy (por si cobró otra persona con su cajón).
-- ============================================================
