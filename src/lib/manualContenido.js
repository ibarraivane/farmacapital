...
export const GLOSARIO = [
  ...
  { id: "recargo", term: "Recargo de farmacia", aliases: ["comisión farmacia", "tu comisión", "los 5 pesos"], def: "Lo que le sumas al cliente por pagarle un recibo o servicio (CFE, Sky, metro…). Hoy arranca en $0 y se ajusta a mano si lo cobras. Las recargas de tiempo aire no llevan recargo. Entra al cajón. No es lo que paga Mercado Pago." },
...
export const TEMAS = [
  ...
  },
  {
    ...
    resumen: "La [[recarga]] se hace en la Point. Aquí solo anotas lo que cobraste. En tiempo aire el recargo va en 0 (ganas el 1% de MP). En recibos (CFE, Sky, metro…) el [[recargo]] arranca en 0 y se puede poner a mano; más la [[compensacion-mp]].",
    pasos: [
      "El cliente pide recarga o pagar un servicio (Telcel, CFE, Sky, metro…). Cobra en efectivo si puedes: con tarjeta, Point se come la ganancia.",
      ...
      "POS → pestaña Servicios. Elige la operadora. Escribe el teléfono o referencia. Monto de la recarga (ej. 50). Las recargas no llevan recargo; en recibos (CFE, Sky, metro…) el recargo arranca en 0 y lo puedes subir a mano. Si sale aviso de saldo bajo, avisa al dueño: hay que fondear Mercado Pago.",
      "Marca «ya pagué» (la recarga ya salió en la Point). Toca Efectivo. En recarga el cliente deja solo el monto (ej. $50). En recibos deja monto + lo que hayas puesto de recargo (si va en 0, solo el monto). Folio SRV-…",
      "Mercado Pago te acredita 1% en tu cuenta cuando la recarga queda hecha. Se ve en Actividad de la app, no en el cajón. En $50 AT&T son $0.50. En un CFE $200 sin recargo son $2 de MP.",
    ...
    dudas: [
      ...
      { q: "¿Los $5 son lo de Mercado Pago?", a: "Ya no cobramos $5 en recargas: el recargo va en 0. Mercado Pago te da el 1% en su app. En recibos (CFE, Sky, metro…) el recargo también arranca en 0; solo súbelo si de verdad lo cobras." },
      ...
      { q: "¿Puedo dejar el recargo en 0?", a: "Sí. En recargas siempre va en 0. En recibos/otros también arranca en 0; el piso puede ponerlo a mano en Servicios o corregirlo en Transacciones." },
  ...
  },
  {
    ...
    pasos: [
      ...
      "En una recarga el recargo va en 0; la ganancia es la compensación MP (1%). En recibos el recargo arranca en 0 y, si lo cobraste, lo ves junto al 1%. El 1% no es venta de mostrador.",
