...
export const GLOSARIO = [
  ...
  { id: "pvp", term: "PVP", aliases: ["precio de venta", "precio al público"], def: "Precio al público. En Inventario del piso se ve y se puede corregir tocando la celda. También aparece en el POS al escanear. No se captura al recibir." },
...
export const TEMAS = [
  ...
  },
  {
    ...
    resumen: "Buscar existencias y ficha del producto. La vendedora ve el PVP y puede corregirlo; el costo solo lo ve el dueño.",
    pasos: [
      "En el menú toca Inventario. Aquí miras existencias y el [[pvp]]. Para meter cajas: Recibir (o el botón Recibir cajas, que te lleva ahí).",
      "No vas a ver pestañas Recibir / Catálogo. Recibir ya no vive dentro de esta pantalla.",
      "Busca por nombre, [[sku]] o [[ean]].",
      "Toca Agotados, Bajo stock, Por caducar, Sin precio, etc. Toca Activos para volver al listado general (igual que Limpiar filtros).",
      "El reporte para pedir (agotados y bajos, por surtidor más barato) está en [[reabasto]], no en esta lista.",
      "La vendedora no ve [[costo]] aquí. El [[pvp]] sí: tócalo para corregirlo si está mal.",
    ...
    dudas: [
      ...
      { q: "¿Dónde veo el precio de venta?", a: "En la columna Precio del Inventario. Tócala para corregir. El [[costo]] sigue oculto en el piso." },
