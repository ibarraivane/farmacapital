...
export const TEMAS = [
  ...
  },
  {
    ...
    pasos: [
      ...
      "Marca «ya pagué» (la recarga ya salió en la Point). Toca Efectivo o Tarjeta, según cómo pagó el cliente. En recarga deja solo el monto (ej. $50). En recibos deja monto + recargo (ej. CFE $200 + $8 = $208). Folio SRV-…",
