...
export const TEMAS = [
  ...
  },
  {
    ...
    pasos: [
      ...
      "POS → pestaña Servicios. Elige la operadora. Escribe el teléfono o referencia. Monto de la recarga (ej. 100). Las recargas no llevan recargo; en recibos (CFE, Sky…) el recargo se suma solo. Si sale aviso de saldo bajo, avisa al dueño: hay que fondear Mercado Pago.",
