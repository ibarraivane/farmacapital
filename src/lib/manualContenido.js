...
export const TEMAS = [
  ...
  },
  {
    ...
    roles: ["vendedor"],
    titulo: "Mi Día",
    resumen: "Tu inicio de turno: cómo vas (tickets + recargas), tickets del turno y atajos. No se reciben cajas aquí.",
    pasos: [
      ...
      "Las [[recarga]]s de tiempo aire que anotas en Servicios también suman a tu % de meta (turno y mes).",
    ...
    dudas: [
      ...
      { q: "¿Las recargas cuentan para mi meta?", a: "Sí. Telcel, AT&T, Movistar y Unefon suman al % del turno y del mes. CFE, Sky y otros recibos no." },
    ],
  },
  {
    id: "pos",
  ...
  },
  {
    ...
    dudas: [
      ...
      { q: "¿Esto es una venta?", a: "No es ticket de productos (no tiene folio VTA). Vive en POS → Servicios. Aun así, la recarga de tiempo aire sí cuenta en tu meta de Mi Día y en comisiones." },
    ],
  },
  {
    id: "devoluciones",
