...
export const TEMAS = [
  ...
  },
  {
    ...
    pasos: [
      ...
      "POS → pestaña Servicios. Elige la operadora. Escribe el teléfono o referencia. Monto de la recarga (ej. 100). El recargo se suma solo ($5 Telcel, $8 CFE, $10 Sky): no lo capturas. Si sale aviso de saldo bajo, avisa al dueño: hay que fondear Mercado Pago.",
    ...
    dudas: [
      ...
      { q: "¿Puedo dejar el recargo en 0?", a: "No. El recargo ya no se escribe: el POS lo pone solo ($5 Telcel, $8 CFE, $10 Sky). Si de verdad no cobraste, el dueño lo corrige en Transacciones." },
