...
export const GLOSARIO = [
  ...
  { id: "pos", term: "POS", aliases: ["punto de venta", "caja registradora"], def: "Punto de venta: escanear, cobrar, receta. En el POS no se elige lote: el sistema descuenta por FEFO (caducidad más próxima). Al escanear, la ficha y el carrito muestran qué caducidad se vende primero." },
