...
export const GLOSARIO = [
  ...
  { id: "borrador", term: "Borrador de recepción", aliases: ["recibir abierto", "ticket pendiente"], def: "Un ticket abierto en Recibir. Arriba ves botones de cada tienda (Farma City, Farmalive, Levic). Tocas uno y salen las cajas. No toques Descartar si es una cola de caducidades." },
...
export const TEMAS = [
  ...
  },
  {
    ...
    pasos: [
      ...
      "Arriba salen botones de cada tienda (Farma City, Farmalive…). Toca uno: abajo se abren las cajas. No hace falta el número del ticket.",
    ...
    dudas: [
      ...
      { q: "Solo veo 6 productos y cargamos dos tickets", a: "Arriba de Recibir hay un botón por tienda. Toca Farma City (11), Farmalive (6) o Levic. No hay que cerrar uno para ver el otro." },
  ...
  },
  {
    ...
    dudas: [
      ...
      { q: "¿Por qué no veo precios?", a: "El [[costo]] (en cuánto compramos) y el [[pvp]] no salen en el Catálogo del piso. El PVP se ve en el POS al escanear." },
