...
export const GLOSARIO = [
  ...
  { id: "recarga", term: "Recarga", aliases: ["tiempo aire", "telcel", "movistar", "servicios", "cfe"], def: "Saldo de celular o pago de luz/TV que se hace en la terminal Point. El cliente paga en efectivo o con tarjeta; el costo sale del saldo de Mercado Pago. Efectivo entra al cajón; tarjeta al corte de tarjeta. La compensación (1%) de MP no entra al cajón." },
  { id: "recargo", term: "Recargo de farmacia", aliases: ["comisión farmacia", "tu comisión", "los 5 pesos"], def: "Lo que le sumas al cliente por pagarle un recibo (el dueño lo fija en POS → Servicios: Izzi $10, CFE $8…). Las recargas de tiempo aire no llevan recargo. Entra al cajón. No es lo que paga Mercado Pago." },
...
export const TEMAS = [
  ...
  },
  {
    ...
    pasos: [
      "El cliente pide recarga o pagar un servicio (Telcel, CFE, Sky…). Cobra en efectivo o con tarjeta. Si es tarjeta, Point se come parte de la ganancia: en montos chicos suele alcanzar; en CFE grande, mejor efectivo.",
      ...
      "POS → pestaña Servicios. Elige la operadora. Escribe el teléfono o referencia. Monto de la recarga (ej. 50). Las recargas no llevan recargo; en recibos (CFE, Izzi, Sky…) el recargo lo pone el dueño y se suma solo. Si sale aviso de saldo bajo, avisa al dueño: hay que fondear Mercado Pago.",
      "Marca «ya pagué» (la recarga ya salió en la Point). Toca Efectivo o Tarjeta, según cómo pagó el cliente. En recarga deja solo el monto (ej. $50). En recibos deja monto + recargo (ej. Izzi $500 + $10 = $510). Folio SRV-…",
      ...
      "Al corte, el efectivo entra al cajón esperado y la tarjeta al total de tarjeta. No lo vuelvas a capturar. El 1% no se cuenta en el cajón: hay que reponer el [[saldo-mp]] con parte de ese efectivo.",
    ],
    dudas: [
      ...
      { q: "¿Puedo cobrar la recarga con tarjeta?", a: "Sí. En Servicios toca Tarjeta (o Cobrar en Point). Entra al corte como tarjeta, no como efectivo. Point cobra su comisión sobre el total: en Telcel $50 te come el 1%; en CFE $500 se pierde dinero." },
      ...
      { q: "¿Puedo dejar el recargo en 0?", a: "En recargas ya va en 0. En recibos el POS suma el recargo que configuró el dueño (POS → Servicios, solo admin). Si de verdad no cobraste, el dueño lo corrige en Transacciones." },
  ...
  },
  {
    ...
    dudas: [
      ...
      { q: "¿Y Cotizaciones?", a: "Es otro módulo, solo dueño/gerente. Ahí se anotan las fuentes, el costo, el precio de venta y la ganancia. Desde aquí el admin toca Abrir cotización." },
    ],
  },
  {
    id: "cotizaciones",
