...
export const GLOSARIO = [
  ...
  { id: "receta", term: "Receta", aliases: ["requiere receta", "controlado"], def: "En antibióticos se recomienda receta, pero no detiene la venta. Solo los controlados exigen receta en el POS (médico, cédula, paciente). La receta del consultorio se imprime en hoja carta (Brother), no en el ticket térmico." },
  { id: "brother", term: "Brother (recetas)", aliases: ["brother", "dcp-l2660", "l2660dw", "impresora receta", "láser"], def: "Impresora láser Brother DCP-L2660DW para recetas médicas. Hoja carta, una cara (sin dúplex). No es la Epson del ticket." },
  { id: "epson", term: "Epson (ticket)", aliases: ["epson", "tm-t20", "térmica", "termica", "ticket 80"], def: "Impresora térmica Epson TM-T20 del mostrador. Solo tickets de 80 mm. Una receta aquí sale minúscula o se come el rollo." },
...
export const TEMAS = [
  ...
  },
  {
    ...
    pasos: [
      ...
      "Cobra (efectivo, tarjeta, mixto). El ticket va a la [[epson]]. La receta del consultorio a la [[brother]].",
    ...
    dudas: [
      ...
      { q: "La receta salió en el rollito térmico", a: "Elegiste la Epson. En el diálogo de impresión cambia a Brother DCP-L2660DW, Carta, una cara." },
    ],
  },
  {
    id: "imprimir-receta",
    moduloId: "pos",
    titulo: "Imprimir receta (Brother)",
    resumen: "La receta del consultorio va a la [[brother]] en hoja carta. El ticket de venta sigue en la [[epson]] de 80 mm.",
    pasos: [
      "POS → Consultas. Si la doctora ya envió la receta, ves el recuadro verde «Recetas del consultorio por imprimir».",
      "Toca Imprimir receta. Se abre el diálogo del navegador (no el ticket de 80 mm).",
      "Elige [[brother]] DCP-L2660DW. Tamaño Carta / Letter. Una cara (la Brother tiene dúplex: apágalo). No «Ajustar a la página».",
      "Firma y sello en tinta si el médico no firmó digital. Entrega la hoja al paciente y surte con origen «médico FarmaCapital».",
      "En Windows, deja la bandeja 1 en Carta (no A4). La receta de México es carta, 215.9 × 279.4 mm.",
    ],
    dudas: [
      { q: "¿Puedo mandar la receta a la Epson?", a: "No. Sale en un rollito y no sirve de receta. Cambia a Brother en el diálogo." },
      { q: "Chrome se queda en la Epson", a: "Normal: recuerda la última. En cada receta revisa el nombre arriba del diálogo." },
      { q: "Sale a dos caras o recortada", a: "Desactiva dúplex. Tamaño Carta, no A4. Escala 100% / Tamaño real." },
    ],
  },
  {
    id: "recargas",
  ...
  },
  {
    ...
    pasos: [
      ...
      "En la ficha: signos, diagnóstico, receta con folio y seguimiento. La receta baja a caja: se imprime en la [[brother]] (carta), no en el ticket.",
