...
export const TEMAS = [
  ...
  },
  {
    ...
    pasos: [
      ...
      "POS → pestaña Servicios. Elige la operadora. Escribe el teléfono o referencia. Monto de la recarga (ej. 100). El recargo ya viene ($5 Telcel, $8 CFE, $10 Sky). Si sale aviso de saldo bajo, avisa al dueño: hay que fondear Mercado Pago.",
