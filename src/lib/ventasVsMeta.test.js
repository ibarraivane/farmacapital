...
describe("fmtDateTimeMexico", () => {
  test("un ticket de las 22:21 en CDMX no se ve como el día siguiente en Europa", () => {
    expect(fmtDateTimeMexico("2026-08-22T04:21:29.91475+00:00")).toMatch(/21.*ago.*10:21/i);
  });
});
