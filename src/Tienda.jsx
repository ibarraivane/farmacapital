...
function ProductCard(props){
  if (tiendaV2Activa()) {
    return <TarjetaProducto prod={props.prod} addToCart={props.addToCart} onClick={props.onClick} />;
  }
    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        body{
          ...
          font-family:${v2 ? "'Archivo', system-ui, -apple-system, sans-serif" : "var(--fc-body)"};
        ...
        ::-webkit-scrollbar{width:6px;}::-webkit-scrollbar-track{background:${v2 ? "#F3F5F8" : C.bg};}::-webkit-scrollbar-thumb{background:${v2 ? "#DCE2EA" : C.border};border-radius:4px;}
      ...
      {v2 ? (
        <EncabezadoV2
          ...
          renderMenu={({ abierto, onClose }) => (
            <MenuTienda
              abierto={abierto}
              onClose={onClose}
              setPage={setPage}
              usuario={user}
              onLogout={() => logoutV2(onClose)}
            />
          )}
        />
      ) : (
