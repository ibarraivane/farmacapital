// InventarioHub: shell con tabs — Recibir, Catálogo, Reabasto, Lotes PEPS, Referencias, Rappi.
...
import { Package, Truck, Tags, TrendingUp, ShoppingBag, ScanLine } from "lucide-react";
          ...
          {!isMobile && (
            <span style={{color: C.textDim, fontSize: 12}}>
              {modoConsulta
                ...
                : "Catálogo · recibir · reabasto · lotes · referencias · Rappi"}
            </span>
          )}
        </div>
        <div style={{
