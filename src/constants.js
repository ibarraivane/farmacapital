...
export const NAV_ADMIN = [
  ...
  "agenda", "cons", "exp_dr",
  "cof", "dev", "fact",
  "promo", "banners", "fichas", "resenas", "cotiz", "bot", "config_cons",
  "usuarios", "rrhh",
  "ayuda", "pwa",
];
...
export const ADMIN_NAV_SECTIONS = [
  ...
  { title: "Comercial y crecimiento", ids: ["promo", "banners", "fichas", "resenas", "cotiz", "bot", "config_cons"] },
...
// Iconos: lucide-react (el Sidebar acepta componente o string).
