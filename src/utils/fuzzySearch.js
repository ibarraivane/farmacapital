...
const CATALOG_QUERY_REPLACEMENTS = [
  ...
  [/\bpegamentos?(?:\s+(?:dentales?|para\s+(?:la\s+|el\s+)?(?:dentadura|protesis|dientes)))?\b/g, "pegamento"],
  [/\badhesivos?\s+(?:dentales?|para\s+(?:la\s+|el\s+)?(?:dentadura|protesis|dientes)|protesis)\b/g, "pegamento"],
  [/\bcrema\s+adhesiva(?:\s+(?:dentales?|para\s+(?:la\s+|el\s+)?(?:dentadura|protesis)))?\b/g, "pegamento"],
  [/\bdientes?\s+postizos?\b/g, "pegamento"],
  [/\bprotesis\s+dentales?\b/g, "pegamento"],
  ...
  [/\bpastillas?\s+azules?\b/g, "sildenafil"],
