...
const INTENCIONES_MOSTRADOR = [
  ...
  { id: "proteccion-solar", label: "protección solar", q: ["bloqueador", "bloqueador solar", "protector solar", "quemadura solar", "anthelios"], name: ["protector solar", "bloqueador", "fps", "spf", "sun", "fotosun", "solsun", "sol sun", "fotoprotector", "anthelios", "la roche"], sub: ["protector solar"] },
