...
Nombres de mostrador salen de ficha (YZA/Fahorro Geslutin, Sufarmed/Klyns Panclasa),
no del renglón del ticket. Sin lote ni MMAA: salen de la caja al escanear.
Cityfarma no publica PDP. Fotos copiadas a catalogo-propia.
"""
...
OUT_TICKET = ROOT / "sql" / "generated" / "ticket_cityfarma_s321781.csv"
OUT_SQL = ROOT / "sql" / "patch_carga_cityfarma_s321781.sql"
...
# Geslutin 200 mg C/15 — YZA + Fahorro EAN 7501871720620 (Asofarma; caja: 15 cápsulas/perlas)
# Panclasa 80/80 mg C/20 — Sufarmed + Klyns EAN 7501471800265 (Atlantis)
ROWS = [
    {
        "ean": "7501871720620",
        "sku": sku_de("7501871720620"),
        "snap": "GESLUTIN 200MG PERLA",
        "nombre": "Geslutin progesterona 200 mg C/15 perlas",
        "qty": 1,
        "pu": 459.50,
        "sub": 459.50,
        "tipo": "marca",
        "categoria": "Hormonales",
        "subcategoria": "Ginecología",
        "forma": "Perlas",
        "marca": "Geslutin",
        "laboratorio": "ASOFARMA",
        "presentacion": "Caja con 15 perlas",
        "principio": "Progesterona micronizada",
        "concentracion": "200 mg",
        "receta": True,
        "ya": False,
        "foto": f"{FOTO_BASE}/geslutin-200mg-15-perlas.jpg",
        "foto_file": "catalogo-propia/geslutin-200mg-15-perlas.jpg",
    },
    {
        "ean": "7501471800265",
        "sku": sku_de("7501471800265"),
        "snap": "PANCLASA C/20 CAPS",
        "nombre": "Panclasa floroglucinol/trimetilfloroglucinol 80/80 mg C/20",
        "qty": 2,
        "pu": 178.19,
        "sub": 356.38,
        "tipo": "marca",
        ...
        "forma": "Cápsulas",
        "marca": "Panclasa",
        "laboratorio": "ATLANTIS",
        "presentacion": "Caja con 20 cápsulas",
        "principio": "Floroglucinol + trimetilfloroglucinol",
        "concentracion": "80/80 mg",
        "receta": True,
        "ya": False,
        "foto": f"{FOTO_BASE}/panclasa-80-80mg-c20.jpg",
        "foto_file": "catalogo-propia/panclasa-80-80mg-c20.jpg",
    },
]
...
def write_sql(path: Path) -> None:
    ...
    body = f"""-- Cityfarma Iztapalapa · orden {FOLIO} · {FECHA} 17:04
...
-- 2 altas stock 0 (Geslutin, Panclasa). No estaban en catálogo.
-- Sin lote ni caducidad (MMAA de la caja). No inventar 0000.
-- Nombres de ficha (YZA/Fahorro, Sufarmed/Klyns), no del ticket.
